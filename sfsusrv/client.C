...
{
  nfs_fh3 *fh = sbp->Xtmpl getarg<nfs_fh3> ();
...
{
  write3args *wa = sbp->Xtmpl getarg<write3args> ();
...
{
  commit3args *ca = sbp->Xtmpl getarg<commit3args> ();
...
{
  rename3args *rn = sbp->Xtmpl getarg<rename3args> ();
...
{
  link3args *lk = sbp->Xtmpl getarg<link3args> ();
...
{
  mkdir3args *mk = sbp->Xtmpl getarg<mkdir3args> ();
...
{
  symlink3args *sl = sbp->Xtmpl getarg<symlink3args> ();
...
{
  setattr3args *sa = sbp->Xtmpl getarg<setattr3args> ();
