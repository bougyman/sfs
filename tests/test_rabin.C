/* $Id: test_rabin.C,v 1.7 2004/04/09 20:47:20 dm Exp $ */
...
main (int argc, char **argv)
{
  ...
  if (opt_v) {
    ...
    warn ("Encrypted 500 messages with %d bit key in %" U64F "u " 
	  TIME_LABEL " per message\n", vsz, etime / 500);
    warn ("Decrypted 500 messages with %d bit key in %" U64F "u " 
	  TIME_LABEL " per message\n", vsz, dtime / 500);
  }
  return 0;
}
